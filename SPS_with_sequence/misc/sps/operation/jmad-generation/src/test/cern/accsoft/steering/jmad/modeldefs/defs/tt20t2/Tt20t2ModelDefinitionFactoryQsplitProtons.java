 ...
 */
public class Tt20t2ModelDefinitionFactoryQsplitProtons implements ModelDefinitionFactory {

    @Override
    public JMadModelDefinition create() {
        JMadModelDefinitionImpl modelDefinition = new JMadModelDefinitionImpl();
        modelDefinition.setName("TT20T2QSPLIT");
    ...
    private final TwissInitialConditionsImpl createTT20T2InitialConditions() {
        ...
        twissInitialConditions.setBetx(19.18);
        twissInitialConditions.setAlfx( -1.95);
        twissInitialConditions.setDx( -0.3031);
        twissInitialConditions.setDpx(-0.0239);
        twissInitialConditions.setBety( 119.7);
        twissInitialConditions.setAlfy(-3.2);
